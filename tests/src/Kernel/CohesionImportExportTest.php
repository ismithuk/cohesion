...
class CohesionImportExportTest extends CohesionContentHubImportExportTest {
  ...
  public static $modules = [
    ...
    'acquia_contenthub',
    'cohesion_elements',
    'cohesion_contenthub_subscriber',
    'cohesion_contenthub_publisher',
    'file',
    'entity_reference_revisions',
    'token',
    'cohesion_templates',
  ...
  protected function setUp() {
    ...
    \Drupal::moduleHandler()->loadInclude('cohesion_contenthub_publisher', 'install');
    \Drupal::moduleHandler()->loadInclude('acquia_contenthub_subscriber', 'install');
    \Drupal::moduleHandler()->loadInclude('cohesion_contenthub_subscriber', 'install');
  }
